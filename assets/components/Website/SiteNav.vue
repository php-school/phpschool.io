...
<template>
    <nav class="bg-nav-pattern bg-center sm:bg-nav-pattern sm:bg-center sm:bg-[length:110%] p-4 w-full z-50" :class="{'py-3': compact}">
                            ...
                            <MenuItems
                                ...
                                <div class="py-1">
                                    <MenuItem v-slot="{ active }">
                                        <a href="/docs" :class="[active ? 'bg-gray-700 text-pink-500 ' : 'text-white', 'block px-4 py-4 text-xs hover:no-underline']">Build a workshop</a>
                                    </MenuItem>
                                    <MenuItem v-slot="{ active }">
