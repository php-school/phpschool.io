...
<template>
    <nav
        class="bg-nav-pattern bg-center sm:bg-nav-pattern sm:bg-center sm:bg-[length:110%] px-4 py-2 w-full z-50 relative"
    >
            ...
            <div class="hidden sm:flex justify-center items-center">
                <ul class="flex space-x-2 md:space-x-4">
                    <li>
                        <router-link
                            to="/"
                            class="text-white text-xs uppercase hover:text-pink-500 cursor-pointer transition duration-150"
                            >Home</router-link
                        >
                    </li>
                    <li>
                    ...
                    <Menu
                        as="li"
                        class="relative text-white text-xs uppercase mt-1"
                        v-slot="{ open }"
                    >
                        <div class="group">
                            <MenuButton
                ...
                <ul
                    v-if="links"
                    class="hidden lg:flex list-none m-0 ml-4 pl-4 py-1 items-center h-full space-x-4 border-l border-pink-600"
                >
                    <li class="m-0">
                        <a
                            :href="links.github"
                            target="_blank"
                            class="block"
                            title="PHPSchool on Github"
                        >
                            <svg
                                class="h-5 w-5 fill-current text-white align-middle hover:text-[#e91e63]"
                                version="1.1"
        ...
        <div :class="mobileMenuVisible ? 'block' : 'hidden sm:hidden '">
            <div class="flex flex-col text-center text-white divide-y divide-pink-500">
                <router-link to="/online" class="py-6 px-4 text-white block hover:text-pink-500 no-underline font-semibold text-xl uppercase  font-open-sans">Workshops</router-link>
                <router-link to="/offline" class="py-6 px-4 text-white block hover:text-pink-500 no-underline font-semibold text-xl uppercase font-open-sans">Offline</router-link>
                <router-link to="/docs" class="py-6 px-4 text-white block hover:text-pink-500 no-underline font-semibold text-xl uppercase font-open-sans">Workshop Documentation</router-link>
                <router-link to="/submit" class="py-6 px-4 text-white block hover:text-pink-500 no-underline font-semibold text-xl uppercase font-open-sans">Submit Your Workshop</router-link>
                <router-link to="/events" class="py-6 px-4 text-white block hover:text-pink-500 no-underline font-semibold text-xl uppercase font-open-sans">Events</router-link>
                <router-link to="/blog" class="py-6 px-4 text-white block hover:text-pink-500 no-underline font-semibold text-xl uppercase font-open-sans">Blog</router-link>
    ...
    <div
        :class="
            mobileMenuVisible
                ? 'block fixed inset-0 backdrop-blur bg-white bg-opacity-40 z-30'
                : 'hidden'
        "
