...
<template>
    <nav class="bg-nav-pattern bg-center sm:bg-nav-pattern sm:bg-center sm:bg-[length:110%] p-4 w-full z-50 relative" :class="{'py-3': compact}">
        <div class=" mx-auto flex items-center justify-between ">
            ...
            <div class="hidden sm:flex justify-center items-center">
                <ul class="flex space-x-2 md:space-x-4">
                    ...
                    <li>
                        <a href="/online/dashboard" class="text-white text-xs uppercase hover:text-pink-500 cursor-pointer transition duration-150">Workshops</a>
                    </li>
                ...
                <ul class="flex list-none m-0 ml-4 pl-4 py-1 items-center h-full space-x-4 border-l border-pink-600">
                    <li class="m-0">
