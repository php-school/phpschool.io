            ...
            <InfoSection :divider="false">
                    ...
                    <div class="w-full lg:w-1/3 space-y-8 sm:px-5 text-left order-2 lg:order-1 mt-8">
                        ...
                        <div class="flex justify-start">
                            <div class="relative w-full flex items-center">
                                ...
                                <PrimaryButton @click="checkInput" class="absolute right-0 flex items-center justify-center m-0 px-2 w-24 text-white text-sm  rounded-xl bg-gradient-to-r from-pink-600 to-purple-500 hover:bg-[#aa1145] transition-all duration-300 ease-in hover:opacity-90 h-[52px] shadow-none normal-case" >
                                    <span>Verify</span>
                ...
                <template #right>
                    <div class="mx-auto w-full lg:w-2/3 lg:mt-0 order-1 lg:order-2">
                        ...
                        <!-- Initial set up -->
                        <div class="items-center justify-center flex relative" id="feedback-section-initial" v-show="showInitialSetup">
                        ...
                        <!-- correct input -->
                        <div class=" items-center justify-center relative flex" id="feedback-section-correct" v-show="showCorrectInput">
                            <img class="cover w-2/3 sm:h-auto sm:w-auto" src="../../../img/cloud/pattern-bg-rectangle.svg" alt="">
                        ...
                        <!-- wrong input -->
                        <div class=" items-center justify-center relative flex shake" id="feedback-section-wrong" v-show="showWrongInput">
                            <img class="cover w-2/3 sm:h-auto sm:w-auto" src="../../../img/cloud/pattern-bg-rectangle.svg" alt="">
                            <div class="absolute flex md:items-center md:justify-center w-[350px] h-[400px] sm:h-[500px] sm:w-[600px] md:h-[500px] md:w-[700px] lg:scale-[0.9] xl:scale-100 xl:h-[500px] xl:w-[800px]">
                                <MockEditor />
                            </div>
