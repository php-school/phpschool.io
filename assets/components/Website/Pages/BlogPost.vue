            ...
            <div class="font-open-sans flex flex-col mx-auto max-w-3xl text-left text-gray-300 p-8">
                <div class="post" v-if="post">
                    <div class="text-center mb-3">
                        <h1 class="text-4xl font-bold leading-normal mt-[9px] mb-3 mx-0 font-mono text-[#e91e63]">{{ post.title }}</h1>
                        <span class="text-xs font-bold hover:text-[#e91e63] hover:underline"><a :href="post.authorLink">{{ post.author }}</a></span>
