...
<template>
    ...
    <div class="w-full bg-gray-900">
        <div class="font-open-sans flex flex-wrap mx-auto max-w-4xl text-left text-gray-300 p-6 pb-20">
            <div class="w-full md:w-1/3 md:pt-8">
                <h2 class="font-mono text-[#e91e63] text-xl mb-2">Built a workshop?</h2>
                <p class=" text-sm">Through this form you can submit your workshop for approval, once approved your workshop will appear on the website and be installable by the workshop manager. To learn how to build a workshop, head over to the <a class="text-[#e91e63] hover:underline" href="/docs">docs</a> or jump on to <a class="text-[#e91e63] hover:underline" href="<?= $links['slack'] ?>">slack</a> for any help!</p>

                <h2 class="font-mono text-[#e91e63] text-xl pt-6 mb-2">What is the approval process?</h2>
                <p class="text-sm">We are just making sure the quality is high and there is not lots of duplicated content across the workshops. We want PHP School to lead the way in quality education material.</p>
