            ...
            <InfoSection>
                <template #left>
                    <div class="w-full lg:w-1/3 space-y-8 sm:px-5 text-left">
                        ...
                        <p class="font-work-sans text-white font-base text-lg">Login in with your GitHub account, select
                            a
                            workshop and an exercise and jump straight in to our web based text editor (IDE). No
                            complicated setup, no
                ...
                <template #right>
                    <div class="mx-auto w-full lg:w-2/3 mt-16 lg:mt-0">
                        <div class=" items-center justify-center flex relative ">
                            <img class="cover sm:h-auto sm:w-auto" src="../../../img/cloud/pattern-bg-rectangle.svg"
                                 alt="">
                            <!-- fadeIn opacity-0 translate-y-6 transition-all ease-in duration-[1000ms]   Classes to add back to mockeditor containing div -->
                            <!-- -->
                            <div class="absolute flex md:items-center md:justify-center w-[350px] h-[400px] sm:h-[500px] sm:w-[600px] md:h-[500px] md:w-[700px] lg:h-[500px] lg:w-[800px]">
                            ...
                            <div class="absolute right-10 lg:-right-16 xl:right-14   top-[90] md:top-[80] lg:top-[30] xl:top-[90] md:w-auto md:h-auto">
                                <div class="absolute -right-4  top-1/4  md:left-4  md:top-[80] lg:top-[30] xl:top-[90] scale-75 sm:scale-95 md:scale-100">
                                    <div class="fadeIn opacity-0 translate-x-10 transition-all ease-in duration-[1000ms]">
                                        <MockWorkshopList/>
                                    </div>
                                </div>
                                <div class=" hidden absolute sm:block -bottom-36 right-10  lg:-bottom-60 lg:left-10 2xl:left-60 z-50">
                                    ...
                                    <img class="bobbing-animation w-auto h-auto "
                                         src="../../../img/cloud/php-elephant-bandana.png" alt=""
                                         srcset="">
                                </div>
                            </div>
                        </div>
            ...
            <InfoSection>
                    ...
                    <div class="mx-auto  w-full lg:w-2/3  relative mt-20">
                        <div class=" items-center justify-center flex relative">
                            ...
                            <div class=" hidden absolute sm:block  -bottom-36 -left-10   lg:-bottom-44   lg:-left-5 z-50">
                                <!-- <div class="ellipse bobbing-animation"></div> -->
                                <img class="bobbing-animation w-auto h-auto" src="/img/cloud/elephant-swim.png" alt=""
                                     srcset="">
                            </div>
                        </div>
                    </div>
                ...
                <template #right>
                    <div class="w-full lg:w-1/3 space-y-8 sm:px-5 mt-28 sm:mt-40 text-left lg:mb-40">
                        ...
                        <p class="font-work-sans text-white font-base text-lg">Level up your problem solving skills
                            whilst tackling
                            practical problems that you will be sure to encounter in your chosen path as a software
                            developer. Each
                            exercise comes with a description, code samples to get you started, links to documentation
                            and other resources
            ...
            <InfoSection :divider="false">
                <template #left>
                    <div class="w-full lg:w-1/3 space-y-8 sm:px-5 text-left order-2 lg:order-1 mt-8">
                        <h2 class="font-work-sans text-white font-bold text-5xl">Get instant feedback and track your
                            progress
                        </h2>
                        <p class="font-work-sans text-white font-base text-lg">You can test your solution at any time
                            and you will get
                            instance feedback, if you get it wrong, we’ll show you how and what went wrong versus what
                            we expected. You’ll
                            know instantly if you need to start fresh or make a simple tweak. When you solve the
                            exercise, your profile is
                            updated and the exercise is marked as completed. Before proceeding you have the opportunity
                            to see our
                            official solution so you can compare notes and optimise your own solution. Maybe your
                            solution is better!
                            <br> <br>
                            Try writing: <code>echo "Hello World";</code> in the input below to see how we verify your
                            solution and
                            provide
                            feedback.
                        </p>
                ...
                <template #right>
                    <div class="mx-auto w-full lg:w-2/3 lg:mt-0 order-1 lg:order-2">
                        ...
                        <!-- Initial set up -->
                        <div class=" items-center justify-center flex relative" id="feedback-section-initial"
                             v-if="showInitialSetup">
                            <img class="cover w-2/3 sm:h-auto sm:w-auto"
                                 src="../../../img/cloud/pattern-bg-rectangle.svg" alt="">
                        ...
                        <!-- correct input -->
                        <div class=" items-center justify-center relative flex" id="feedback-section-correct"
                        ...
                        <!-- wrong input -->
                        <div class=" items-center justify-center relative flex shake" id="feedback-section-wrong"
                             v-if="showWrongInput">
                            <img class="cover w-2/3 sm:h-auto sm:w-auto"
                                 src="../../../img/cloud/pattern-bg-rectangle.svg" alt="">
                            <div class="absolute flex md:items-center md:justify-center w-[350px] h-[400px] sm:h-[500px] sm:w-[600px] md:h-[500px] md:w-[700px] lg:scale-[0.9] xl:scale-100 xl:h-[500px] xl:w-[800px]">
