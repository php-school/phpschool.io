            ...
            <div class="flex flex-col mx-auto max-w-3xl text-left text-gray-800 p-8">
                ...
                <div v-if="events.events.length > 0" class="w-full pb-6">
                    ...
                    <ul v-if="events.events.length > 0" class="w-full pb-6" >
                        ...
                        <li class="p-8 border-b last:border-none border-gray-600" v-for="event in events.events">
                ...
                <ul v-if="events.previousEvents.length > 0" class="w-full pt-6">
                    ...
                    <li class="p-8 border-b last:border-none border-gray-600" v-for="event in events.previousEvents">
                        <h3 class="text-lg text-gray-300 pb-4 font-mono">{{event.date_formatted}}</h3>
                        <h2 class="text-2xl pb-6 text-[#e91e63] font-mono font-bold"> {{event.name}}</h2>
