        ...
        <section class="bg-gradient-to-b from-gray-900 to-cyan-500 bg-fixed items-stretch">
            <Heading>
                ...
                <template v-slot:description>
                    Ready for the next steps? Use the PHP School workshop documentation to build you
                    own workshop and help teach others how to code with PHP!
                </template>
            </Heading>
        </section>
            ...
            <div class="font-open-sans flex flex-wrap text-left text-gray-800 p-6">
                <div class="w-full md:w-3/12 md:pt-8 border-r border-gray-600 pl-48 bg-gray-900">
                    ...
                    <template v-for="group in docs" :key="group.title">
                        <h2
                            class="font-mono text-base pt-4 pb-4 mb-4 border-b border-gray-600 text-white"
                        >
                            {{ group.title }}
                        </h2>
                        ...
                        <ul class="">
                            <li v-for="section in group.sections" :key="section.title">
                                <router-link
                                    ...
                                    class="block font-open-sans px-3 py-1.5 text-sm text-[#e91e63] hover:underline"
                                >
                                    {{ section.title }}
                                </router-link>
                            </li>
                ...
                <div class="docs-content w-full md:w-9/12 px-12 pr-48">
                    ...
                    <div class="border-t border-gray-600 flex pt-4 pb-2.5">
                        <div class="text-left w-[40%]">
                            <router-link
                                v-if="previousSection !== null"
                                class="text-sm text-white"
                                :to="prevLink"
                                >⇠ {{ previousSection.title }}</router-link
                            >
                        </div>
                        ...
                        <div class="text-right w-[40%]">
                            <router-link
                                v-if="nextSection !== null"
                                class="text-sm text-white"
                                :to="nextLink"
                                >{{ nextSection.title }} ⇢</router-link
                            >
                        </div>
                    </div>
                </div>
