...
<template>
    <div class="group border-gray-600 rounded-lg border border-solid p-4 w-full lg:w-3/5 m-4 mt-8 lg:m-0 lg:mt-0">
        <div class="flex flex-col">
            <div class="flex justify-between items-center pb-10">
                ...
                <ClipboardDocumentIcon v-if="clipboardAvailable && !copied" @click="copy" class="opacity-0 group-hover:opacity-100 text-gray-300 w-5 h-5 hover:cursor-pointer hover:text-pink-600 transition-all duration-300"></ClipboardDocumentIcon>
            ...
            <div class="bg-gray-900 border-none text-white p-0 lg:px-10 whitespace-pre-wrap font-mono">
                <div v-for="line in lines">
                    ...
                    <span v-else class="before:mr-2 before:text-pink-600 whitespace-pre before:content-['$']">{{line}}</span>
                </div>
            </div>
        </div>
    </div>
