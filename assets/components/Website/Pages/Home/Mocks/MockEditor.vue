<template>
    <div
        class="h-full w-full relative bg-gray-900 border p-1.5 editor-border border-2 border-solid border-transparent rounded-[20px] shadow-[-20px_20px_0_rgba(0,0,0,0.2)]"
    >
        <div class="h-full flex flex-col">
            <div class="flex flex-1 h-full relative">
                <div class="w-4/12 md:w-3/12">
                    <div class="">
                        <div
                            class="border-b border-solid border-gray-600 p-2 md:py-3 md:px-3 flex justify-between"
                        >
                            ...
                            <div class="flex text-white">
                                <svg
                                    ...
                                    stroke="currentColor"
                                    aria-hidden="true"
                                    class="hidden md:flex mr-2 h-3 w-3"
                        ...
                        <ul class="w-full text-gray-300 font-mono p-1 text-[8px] md:text-[10px]">
                            ...
                            <li class="flex flex-col pl-1 py-1 w-full">
                                <div
                                    class="group flex w-full items-center justify-between cursor-pointer"
                                >
                                    <div class="flex items-center min-w-0">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <span class="hover:text-white flex-1 truncate" style=""
                                            >cloud</span
                                        >
                                ...
                                <div class="ml-3" style="">
                                    <ul class="mt-1 w-full text-gray-300">
                                        <li class="flex flex-col pl-1 py-1 w-full">
                                            <div
                                                class="group flex w-full items-center justify-between cursor-pointer"
                                            >
                                                <div class="flex items-center min-w-0">
                                                    ...
                                                    <span
                                                        class="hover:text-white flex-1 truncate"
                                                        style=""
                                                        >workshop.php</span
                                                    >
                                                </div>
                ...
                <div class="flex border-l border-solid border-gray-600 h-full w-9/12">
                    <div class="tabs w-full flex flex-col">
                        <ul
                            class="tabs list-reset flex justify-start flex-none border-solid border-gray-600"
                        >
                            <li
                                class="flex justify-between border-solid border-r border-r-gray-600 pl-2 pr-1 inline-block text-white hover:text-pink-500 text-xs no-underline items-center border-t -mt-[1px] border-t-pink-600"
                            >
                                <a
                                    href="#"
                                    class="text-xs text-gray-300 hover:no-underline py-3 pl-1 text-pink-600"
                                    >solution.php</a
                                >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="h-full flex flex-1 bg-gray-900">
                            <div
                                class="h-full w-5 flex flex-col text-[10px] text-[#8F908A] bg-gradient-to-b to-30% from-gray-900 to-[#0c1220]"
                            >
            ...
            <!-- start footer -->
            <div
                class="border-t border-solid border-gray-600 flex-none flex items-center justify-between px-1 pt-1 pb-1 md:px-2 md:pt-2 md:pb-2"
            >
                        ...
                        <li>
                            <div class="flex items-center">
                                <svg
                                    ...
                                    fill="currentColor"
                                    aria-hidden="true"
                                    class="w-2.5 h-2.5 text-pink-500"
                                >
                                    <path
                                        fill-rule="evenodd"
                ...
                <div
                    class="w-1/6 bg-gray-200 rounded-full h-4 bg-gray-700 mt-0 relative hidden md:flex justify-center items-center"
                >
                    <div
                    ...
                    ></div>
                    <p
                        class="absolute inline-flex items-center text-[8px] font-bold text-white ml-2 mx-auto"
                    >
                        0 / 24 completed
                    </p>
                </div>
                <div class="flex">
                    <button
                        class="border-[#E91E63] text-[10px] border-solid border-2 text-white hidden md:flex items-center justify-center mt-0 mr-2 rounded py-1 px-2 w-30"
                    >
                    ...
                    <div class="flex items-center">
                        <button
                            id="run"
                            class="text-[10px] border-[#E91E63] border-solid border-2 text-white hidden md:flex items-center justify-center mt-0 mr-2 py-1 px-2 w-18 rounded"
                        >
                            <span>Run</span>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <button
                            id="verify"
                            class="text-[10px] text-white flex items-center justify-center mt-0 py-1.5 px-2 w-18 rounded bg-gradient-to-r from-pink-600 to-purple-500"
                        >
                            <span>Verify</span>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
...
.editor-border {
    background:
        padding-box linear-gradient(rgb(17 24 39), rgb(17 24 39)),
