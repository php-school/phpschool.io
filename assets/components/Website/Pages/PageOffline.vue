...
<template>
    <div>
        <section class="bg-gradient-to-b from-gray-900 to-cyan-500 bg-fixed items-stretch">
            <Heading>
                <template v-slot:title> PHP School on the <br />Command Line </template>

                <template v-slot:description>
                    In order to get started with PHP School workshops, you first need to install the
                    workshop manager. Before we can do this we need to check you have a few things
                </template>
            </Heading>
        </section>
        <PageSection>
                ...
                <ol class="mx-auto w-full flex flex-col">
                    <li class="w-full p-4 flex justify-between mb-12">
                        <div class="flex flex-col">
                            <div
                                class="bg-slate-800 rounded font-bold w-8 h-8 flex items-center justify-center mb-4"
                            >
                                <CogIcon class="h-6 w-6 text-white !fill-none" />
                            </div>
                            <div
                                class="border-l border-solid border-slate-800 flex-grow ml-4"
                            ></div>
                        </div>
                        ...
                        <div class="w-full flex flex-col">
                            <div class="flex-1 px-4 mr-8 w-full">
                                <h4
                                    class="text-lg font-work-sans font-bold capitalize text-pink-600 mt-0 p-0 not-italic"
                                >
                                    Requirements Check
                                </h4>
                                <p class="text-sm text-gray-300 mt-4">
                                    In order to get started with PHP School workshops, you first
                                    need to install the workshop manager. Before we can do this we
                                    need to check you have a few things:
                                </p>
                            </div>
                            ...
                            <ul class="list-none p-4 w-full m-0 mt-8 lg:m-0 lg:mt-0">
                                <li class="flex p-2">
                                    <CheckIcon
                                        fill="currentColor"
                                        class="flex-shrink-0 w-5 h-5 text-green-500 mr-4"
                                    />
                                    <p>
                                        You will need PHP with a version of at least 7.1 although we
                                        recommend using the latest available.
                                    </p>
                                </li>
                                <li class="flex p-2">
                                    <CheckIcon
                                    ...
                                    />
                                    <p>
                                        You will also need a Text Editor so you can work through the
                                        workshops. You can try Atom or Sublime if you don't already
                                        have one.
                                    </p>
                                </li>
                            </ul>
                            ...
                            <div class="flex-1 px-4 mr-8 w-full">
                                <p class="text-sm text-gray-300 mt-4">
                                    Once the above are satisfied, run the following commands in your
                                    terminal, to install the workshop manager.
                                </p>
                            </div>
                        </div>
                    </li>
