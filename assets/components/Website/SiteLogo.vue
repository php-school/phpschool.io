<template>
    <svg
        class="h-20 w-20 transition ease-in duration-150 hover:text-[#e91e63]"
        version="1.1"
        fill="currentColor"
    ...
    >
        ...
        <g>
            ...
            />
            <path
                d="M0,0v125.7l85.7,41.7l85.6-41.7V0H0z M167.5,122l-81.8,39.8l-0.4-0.2L3.8,122V4.7h163.7V122z"
            />
            <path
