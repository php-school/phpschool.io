...
<template>
    ...
    <p>Listener checks are more advanced - when you add a listener type check, it will be passed an event dispatcher
        ...
        the <router-link to="/docs/reference/creating-listener-checks">Listener checks documentation</router-link>.</p>
    ...
    <CodeBlock lang="php"><pre>class MyExercise extends AbstractExercise implements ExerciseInterface
{
    ...snip
    ...
    <p>This basically informs the workshop framework that when verifying the student's solution to this exercise, we should
        ...
        to the <router-link to="/docs/reference/bundled-checks">Bundled Checks</router-link> page.</p>
    ...
    <p>The second and final step is to implement the correct interface in your exercise. If you do not do this the workshop
        ...
        <router-link to="/docs/reference/bundled-checks">Bundled Checks</router-link> page or by looking at the
    ...
    <CodeBlock lang="php"><pre>class MyExercise extends AbstractExercise implements
        ExerciseInterface,
