...
echo "Where is the database?";
  ...
  <a href="/img/database-check-failure.png">
    <img src="../../../../../img/cloud/docs/database-check-failure.png" class="doc-terminal-screen" />
  </a>
...
$stmt->execute([':name' => 'Karl Renner', ':age' => 80, ':gender' => 'Male']);
  ...
  <a href="/img/database-check-success.png">
    <img src="../../../../../img/cloud/docs/database-check-success.png" class="doc-terminal-screen" />
  </a>
</template>
