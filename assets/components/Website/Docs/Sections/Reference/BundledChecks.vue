...
<template>
    <p>This article documents each of the checks bundled with the workshop framework and how to use them. Remember the
        exercise types from the <router-link to="/docs/reference/exercise-types">Exercise Types documentation</router-link>?
        ...
        <router-link to="/docs/reference/exercise-types#custom">CUSTOM</router-link>.</p>
    ...
    <CodeBlock lang="php"><pre>class MyExercise extends AbstractExercise
...
echo file_get_contents('http://example.com');
    ...
    <a href="/img/func-requirements.png"><img src="../../../../../img/cloud/docs/func-requirements.png" class="doc-terminal-screen"></a>
        ...
        implements ExerciseInterface, ComposerExerciseCheck
{
    ...
    <a href="/img/composer-check.png"><img src="../../../../../img/cloud/docs/composer-check.png" class="doc-terminal-screen"></a>
...
echo "Where is the database?";
    ...
    <a href="/img/database-check-failure.png"><img src="../../../../../img/cloud/docs/database-check-failure.png" class="doc-terminal-screen"></a>
...
$stmt->execute([':name' => 'Karl Renner', ':age' => 80, ':gender' => 'Male']);
    ...
    <a href="/img/database-check-success.png"><img src="../../../../../img/cloud/docs/database-check-success.png" class="doc-terminal-screen"></a>
</template>