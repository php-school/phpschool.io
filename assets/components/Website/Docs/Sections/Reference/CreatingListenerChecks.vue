...
<template>
  ...
  <p>Couch DB is a NoSQL database, which stores data as JSON documents and it's API is provided via regular HTTP.</p>
  ...
  <p>
    ...
    . We can use
    <Code>cli.verify.reference-execute.pre</Code>
    ,
    <Code>cli.verify.student-execute.pre</Code>
    &
    <Code>cli.run.student-execute.pre</Code>
    .
  </p>
  ...
  <p>
    ...
    <Code>cli.verify.reference-execute.fail</Code>
...
interface CouchDbExerciseCheck
{
  ...
  <p>
    ...
    <Code>src/Check/CouchDbCheck.php</Code>
...
class CouchDbCheck implements ListenableCheckInterface
{
  ...
  <p>
    ...
    <Code>PhpSchool\PhpWorkshop\Check\ListenableCheckInterface</Code>
    instead of
    ...
    <Code>getExerciseInterface()</Code>
    .
    <Code>ListenableCheckInterface</Code>
...
class CouchDbCheck implements ListenableCheckInterface
{
  ...
  <Note type="info">
    ...
    <Code>doctrine/couchdb</Code>
    even though it is a dependency of
    <Code>php-school/couch-db-check</Code>
  ...
  <p>
    ...
    <Code>exercises/couch-db-exercise/problem/problem.md</Code>
...
----------------------------------------------------------------------
  ...
  <p>
    ...
    <Code>src/Exercise/CouchDbExercise.php</Code>
    :
  </p>
    ...
    CouchDbExerciseCheck
{
  ...
  <p>
    ...
    <Code>exercises/couch-db-exercise/solution</Code>
