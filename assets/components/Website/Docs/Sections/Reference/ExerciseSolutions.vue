...
<template>
    <p>Every CGI & CLI type exercise must have a reference solution. The solution represents a complete working example of how to solve the
...
//Outputs: "contents-of-the-file"</pre></CodeBlock>
    ...
    <CodeBlock lang="php"><pre>/path/to/workshop/exercises/exercise-name/solution
├── SomeClass.php
└── solution.php
</pre></CodeBlock>
...
//Outputs: "contents-of-the-file"</pre></CodeBlock>
    ...
    <CodeBlock lang="php"><pre>/path/to/workshop/exercises/exercise-name
├── SomeClass.php
└── index.php
</pre></CodeBlock>
...
$solution = DirectorySolution::fromDirectory('/path/to/workshop/exercises/exercise-name', [], 'index.php');
    ...
    <Note type="info">The convention is for the entry point file to be named <Code>solution.php</Code> to keep things simple.</Note>
    <Note type="danger"><Code>DirectorySolution</Code> will throw an instance of <Code>InvalidArgumentException</Code> if the entry point does not exist in the directory given.</Note>
...
$solution = new DirectorySolution(
    ...
    <Note type="info">The argument order for <Code>__construct</Code> and <Code>fromDirectory</Code> are slightly different. <Code>__construct</Code> is: $directory, $entryPoint, $excludes. <Code>fromDirectory</Code> is: $directory, $excludes, $entryPoint.</Note>
    ...
    <Note type="success">This means that you don't need to commit the vendor directory for each reference solution.
    </Note>
    ...
    <CodeBlock lang="php"><pre>interface SolutionInterface
{
    /**
     * @return string
     */
