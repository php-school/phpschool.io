...
<template>
    <p>As we have seen in the previous articles, you can build your own custom checks. Checks can be used in as many
        ...
        <router-link to="/docs/reference/creating-simple-checks">Creating Simple Checks</router-link> article is a good example of a reusable
    ...
    <p>Creating a self checking exercise requires implementing the interface
        ...
        <router-link to="/docs/reference/results">result</router-link>. Depending on whether you want a success or a failure
...
class Mean extends AbstractExercise implements ExerciseInterface, CliExercise, SelfCheck
{
    ...
    <Note type="success">Learn more about results <router-link to="/docs/reference/results">here</router-link>.</Note>
...
public function check(Input $input)
{
    ...
    <a href="/img/psr2-success.png"><img src="../../../../../img/cloud/docs/psr2-success.png" class="doc-terminal-screen"></a>
