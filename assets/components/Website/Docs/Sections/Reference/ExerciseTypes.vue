...
<template>
    ...
    <ExerciseType :type="'ExerciseType::CLI()'" :interface="'PhpSchool\PhpWorkshop\Exercise\CliExercise'" :methods="'getArgs'"></ExerciseType>
...
class MyExercise extends AbstractExercise implements ExerciseInterface, CliExercise
{
    ...
    <CodeBlock lang="sh"><pre>php solution.php 'arg1' 'arg2' 'arg3'</pre></CodeBlock>
    <p>And then:</p>
    <CodeBlock lang="sh"><pre>php solution.php 'run2-arg1' 'run2-arg2' 'run2-arg3'</pre></CodeBlock>
    ...
    <ExerciseType :type="'ExerciseType::CGI()'" :interface="'PhpSchool\PhpWorkshop\Exercise\CgiExercise'" :methods="'getRequests'"></ExerciseType>
...
class MyExercise extends AbstractExercise implements ExerciseInterface, CgiExercise
{
    ...
    **
    ...
    <CodeBlock lang="php"><pre>//$_SERVER
array(13) {
...
class MyExercise extends AbstractExercise implements ExerciseInterface, CgiExercise
{
 ...
 array(2) {
    ...
    <ExerciseType :type="'ExerciseType::CUSTOM()'" :interface="'PhpSchool\PhpWorkshop\Exercise\CustomVerifyingExercise'" :methods="'verify'"></ExerciseType>
    ...
    <p>This is where you perform your verification. The method needs to return an instance of <Code>PhpSchool\PhpWorkshop\Result\ResultInterface</Code>. Depending on
        ...
        <router-link to="/docs/reference/result">here</router-link>.</p>
