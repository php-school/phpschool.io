...
<template>
    ...
    <p>Results are what <router-link to="/docs/reference/exercise-checks">Exercise Checks</router-link> should return and inject. You will
        learn more about how to actually use the results in your checks in a
        <router-link to="/docs/reference/exercise-checks">later article</router-link>.</p>
...
interface ResultInterface
{
    ...
    <p>There are default implementations for <Code>SuccessInterface</Code> & <Code>FailureInterface</Code> for you to use
        ...
        <router-link to="/docs/reference/creating-custom-results">create your own</router-link>.</p>
...
$failure = Failure::fromCheckAndReason($check, 'Something went wrong!');
    ...
    <p>When you want to report information that is not simple a message, you will need to create
        ...
        <router-link to="/docs/reference/creating-custom-results">in a later article</router-link>.</p>
...
interface ResultRendererInterface
{
    ...
    <ul>
        <li><Code>style($string, $colourOrStyle)</Code> - Use to style a string, eg. <Code>bold</Code>, <Code>green</Code>. It accepts an array of styles or one style as a string</li>
        <li><Code>lineBreak()</Code> - Use to render a line break, to separate content.</li>
        <li><Code>center()</Code> - Pad a string according to the terminal width so it displays in the center</li>
    </ul>
    ...
    <ResultRendererMappings :results="[
    ...
    <p>In the next set of articles we will learn about and build a check. Once the check is complete, we will
        ...
        <router-link to="/docs/reference/creating-custom-results">straight there if you want</router-link>.</p>
