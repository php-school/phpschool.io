...
<template>
    ...
    <Note type="warning">Be aware that anything already using the <Code>Symfony\Component\Filesystem\Filesystem</Code> service will expect it to be an instance of <Code>\Symfony\Component\Filesystem\Filesystem</Code>, so if you replace it with an altogether different object, expect things to break!</Note>

    <p>Check <router-link to="/docs/reference/available-services">Available Services</router-link> for a list and description of services available to you.</p>
