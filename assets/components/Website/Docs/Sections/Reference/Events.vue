...
<template>
    <p>There are various events triggered throughout the verifying and running of exercises. These events
        can be used by <router-link to="/docs/reference/creating-listener-checks">Listener Checks</router-link> to hook in to the process
...
$eventDispatcher->listen(['verify.start', 'run.start'], function (Event $event) {
    ...
    <Note type="info">Learn more about results <router-link to="/docs/reference/results">here</router-link>.</Note>
...
$eventDispatcher->insertVerifier('verify.finish', function (Event $event) {
    ...
    <TabGroup as="div" class="mb-8">
        ...
        <TabPanels>
            <TabPanel class="p-6 pb-0 border-b border-l border-r border-gray-600 focus:outline-none">
