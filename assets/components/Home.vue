...
<template>
  <div class="flex flex-col w-full overflow-hidden">
    <!-- Navigation Start -->
    <nav class="bg-nav-pattern bg-center bg-[length:110%] p-4">
      <div class="mobile-blur"></div>
    ...
    <div :class="mobileMenuVisible ? 'block' : 'hidden sm:hidden'">
      <div class="bg-gray-900 py-2 px-4 text-center">
        <ul class="space-y-2">
          <li><a href="#" class="text-white block">Home</a></li>
          <li><a href="#" class="text-white block">About</a></li>
          <li><a href="#" class="text-white block">Services</a></li>
        ...
        <div class="my-4">
          <Button href=" /cloud" class=" mx-auto text-center px-4 py-2">
            <GitHubIcon class="h-5 w-5 inline-block align-middle mr-2" /><span
              class="text-xs font-normal inline-block align-middle">Log In with
              github</span>
          </Button>
        </div>
      </div>
