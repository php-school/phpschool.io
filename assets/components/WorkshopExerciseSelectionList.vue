...
<template>
  <div class="w-full grid grid-cols-4 gap-4 mt-10 mb-10 h-full">
    <div class="col-span-2">
      <div id="workshops" class="flex flex-col items-center justify-center bg-gray-800 rounded-lg shadow">
        ...
        <ul id="workshops-list" class="flex flex-col divide divide-y">
          <li v-for="workshop in workshops" @click="selectWorkshop(workshop.code)" :class="{ 'bg-gray-700': selectedWorkshop && workshop.code === selectedWorkshop.code }" class="group flex flex-row hover:bg-gray-600 last:rounded-b-lg">
            <div class="select-none cursor-pointer flex flex-1 items-center p-4">
              ...
              <div class="flex-1 pl-1 mr-16 text-white group-hover:text-pink-600">
                ...
                <div class="text-gray-300 text-sm">{{ workshop.description }}</div>
              </div>
    ...
    <div class="col-span-2 h-full">
      ...
      <div v-if="selectedWorkshop" id="workshop-exercises" class="flex flex-col items-center justify-center bg-gray-800 rounded-lg shadow h-full">
        ...
        <ul id="workshop-exercises-list" class="flex flex-col w-full divide divide-y h-full overflow-y-scroll">
          <exercise-entry v-for="exercise in selectedWorkshop.exercises"
                    :exercise="exercise"
