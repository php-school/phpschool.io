...
<template>
  <div class="w-full flex h-full overflow-hidden gap-4 mt-10">
    <div class="w-1/2 h-full">
      <div id="workshops" class="flex flex-col items-center justify-center bg-gray-800 rounded-lg shadow">
        ...
        <ul id="workshops-list" class="flex flex-col divide divide-y overflow-hidden overflow-scroll">
    ...
    <div class="w-1/2 h-full">
      <div v-if="selectedWorkshop === null" class="flex flex-col items-center justify-center">
        <h1 class="text-2xl">Select a workshop</h1>
      ...
      <div v-if="selectedWorkshop" id="workshop-exercises" class="flex flex-col items-center bg-gray-800 rounded-lg  shadow h-full overflow-hidden overflow-y-scroll">
        <div class="px-4 py-5 sm:px-6 border-b w-full">
