  ...
  <div class="w-full flex h-full overflow-hidden gap-4 mt-10">
    <div class="w-1/2 h-full">
      <div id="workshops" class="flex flex-col items-center justify-center bg-gray-800 rounded-lg shadow">
        ...
        <ul id="workshops-list" class="flex flex-col divide divide-y overflow-hidden">
          <li
      ...
      <div
        ...
        <div class="px-4 py-5 sm:px-6 border-b w-full">
          <div class="w-full flex flex-col items-center">
            <h3 class="text-lg leading-6 font-medium text-white">{{ selectedWorkshop.name }} Exercises</h3>
