...
const navigation = [
    ...
    {
        name: 'Workshop Installs',
        to: '/admin/workshop-installs',
        icon: ChartBarIcon
    },
...
<template>
    <div class="">
                ...
                <div class="fixed inset-0 flex">
                    ...
                    >
                        <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
                            ...
                            <div
                                class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 ring-1 ring-pink-600/30"
                            >
        ...
        <div class="hidden xl:fixed xl:inset-y-0 xl:z-50 xl:flex xl:w-72 xl:flex-col">
            <div
                class="flex grow flex-col gap-y-5 overflow-y-auto bg-black/10 px-6 ring-1 ring-pink-600/30"
            >
                <div class="flex h-16 shrink-0 items-center">
        ...
        <div class="xl:pl-72">
            ...
            <div
                class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-6 border-b border-pink-600/30 bg-gray-900 pl-4 shadow-sm sm:pl-6 lg:pl-8 pr-2"
            >
                <button
                    type="button"
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    <Menu as="div" class="relative ml-3">
                        <div>
                            <MenuButton
                                class="relative flex max-w-xs items-center h-full text-sm focus:outline-none rounded-md lg:p-2 hover:bg-gray-800"
                            >
                                ...
                                >
                                <ChevronDownIcon
                                    class="ml-1 hidden h-5 w-5 flex-shrink-0 text-white lg:block"
                                    aria-hidden="true"
                                />
                            </MenuButton>
                        </div>
                                ...
                                <MenuItem v-slot="{ active }">
                                    <button
                                        ...
                                        :class="[
                                            ...
                                            'w-full text-left rounded-md block px-4 py-2 text-sm text-slate-400'
                                        ]"
                                    >
                                        Logout
                                    </button>
                ...
                <ul role="list" class="divide-y divide-white/5">
                    ...
                    >
                        ...
                        <p class="mt-3 text-sm text-gray-500">
                            Submitted
                            <span class="text-gray-400">{{ item.name }}</span> (<span
                            ...
                            <a
                                :href="item.repo_url"
                                target="_blank"
                                class="hover:cursor-pointer hover:underline text-blue-600 text-xs"
                                >{{ item.repo_url }}</a
                            >.
                        </p>
                    </li>
