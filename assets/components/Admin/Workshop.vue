...
<template>
    <header class="flex items-center justify-between border-b border-pink-600/30 px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
        <h1 class="text-base font-semibold leading-7 text-white">{{workshop.name}}</h1>
    </header>
    ...
    <div class="">
        <dl class="divide-y divide-white/10">
            <div class="px-4 py-6 sm:px-6 lg:px-8 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-400 sm:col-span-2 sm:mt-0">{{workshop.code}}</dd>
            </div>
            <div class="px-4 py-6 sm:px-6 lg:px-8 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                <dt class="text-sm font-medium leading-6 text-white">Workshop Name</dt>
                <dd class="mt-1 text-sm leading-6 text-gray-400 sm:col-span-2 sm:mt-0">{{workshop.name}}</dd>
            </div>
            <div class="px-4 py-6 sm:px-6 lg:px-8 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                <dt class="text-sm font-medium leading-6 text-white">Workshop Description</dt>
                <dd class="mt-1 text-sm leading-6 text-gray-400 sm:col-span-2 sm:mt-0">{{workshop.description}}</dd>
            </div>
            <div class="px-4 py-6 sm:px-6 lg:px-8 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            ...
            <div class="px-4 py-6 sm:px-6 lg:px-8 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-400 sm:col-span-2 sm:mt-0">{{workshop.submitter_name}}</dd>
            </div>
            <div class="px-4 py-6 sm:px-6 lg:px-8 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                <dt class="text-sm font-medium leading-6 text-white">Submitter email</dt>
                <dd class="mt-1 text-sm leading-6 text-gray-400 sm:col-span-2 sm:mt-0">{{workshop.submitter_email}}</dd>
            </div>
            <div class="px-4 py-6 sm:px-6 lg:px-8 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                <dt class="text-sm font-medium leading-6 text-white">Submitter contact</dt>
                <dd class="mt-1 text-sm leading-6 text-gray-400 sm:col-span-2 sm:mt-0">{{workshop.submitter_contact}}</dd>
            </div>
        </dl>
    </div>
