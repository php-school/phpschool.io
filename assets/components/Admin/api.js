...
export const approveWorkshop = async (id) => {
  const response = await adminFetch(`/api/admin/workshop/approve/${id}`, {
    method: "POST",
  });
...
export const promoteWorkshop = async (id) => {
  const response = await adminFetch(`/api/admin/workshop/promote/${id}`, {
    method: "POST",
  });
...
export const deleteWorkshop = async (id) => {
  const response = await adminFetch(`/api/admin/workshop/delete/${id}`, {
    method: "DELETE",
  });
...
export const deleteEvent = async (id) => {
  const response = await adminFetch(`/api/admin/event/delete/${id}`, {
    method: "DELETE",
  });
...
export const regenerateWorkshopFeed = async () => {
  const response = await adminFetch("/api/admin/workshop/regenerate", {
    method: "POST",
  });
