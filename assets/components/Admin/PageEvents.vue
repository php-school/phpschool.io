        ...
        <Dialog as="div" class="relative z-50" @close="showAdd = false">
            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                ...
                >
                    ...
                    >
                        <DialogPanel
                            class="relative transform overflow-hidden rounded-lg bg-gray-900 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 w-full md:max-w-2xl sm:p-6"
                        >
                            <div class="sm:flex sm:items-start">
                                <form
