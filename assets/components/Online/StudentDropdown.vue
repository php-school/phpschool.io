        ...
        <div :class="{'sm:hidden': !isOpen }" v-click-away="clickAway"
            ...
            <ul class="py-2 text-sm text-gray-200">
                <li>
                    <router-link
                        to="/online"
                        class="block text-left no-underline px-6 py-2 hover:bg-gray-600 hover:text-white"
                        >Workshop Dashboard</router-link
                    >
                </li>
                ...
                <li>
                    <a
                        href="#"
                        @click="resetState"
                        class="flex justify-between text-left no-underline px-6 py-2 hover:bg-gray-600 hover:text-white"
                    >
                        <span>Reset Progress</span>
                        <ArrowPathIcon
                            v-cloak
                            v-show="loadingStateReset"
                            class="w-4 h-4 animate-spin text-pink-500"
                        />
                    </a>
                </li>
            </ul>
            ...
            <div class="py-3">
                <a
                    href="#"
                    @click="logout"
                    class="block text-left no-underline px-6 py-2 text-sm hover:bg-gray-600 text-gray-200 hover:text-white"
                    >Sign out</a
                >
            </div>
        </div>
