            ...
            <template #body>
                    ...
                    <div class="flex flex-wrap items-center">
                        <div class="flex items-center">
                            <p class="truncate font-medium text-white">
                                <span class="text-sm"
                                    >Your program was required to use various composer
                                    packages.</span
                                >
                            </p>
                        </div>
                ...
                <div id="composer-requirements" class="flex space-x-4">
                    <div v-if="data.is_missing_component" class="">
                        ...
                        <p class="mb-4 text-sm">
                            The file <code>{{ data.missing_component }}</code> is missing. You must
                            specify some requirements for the file to be created.
                        </p>
                    </div>
                </div>
                ...
                <div id="composer-requirements" class="flex space-x-4">
                    <div v-if="data.is_missing_packages" class="">
                        ...
                        <p class="mb-4 text-sm">
                            Some packages were not required which should be used in this exercise:
                        </p>
                        <code
                            class="inline-block mr-2 text-xs mb-2"
                            v-for="composerPackage in data.missing_packages" :key="composerPackage"
                            >{{ composerPackage }}
                        </code>
                    </div>
                </div>
