...
const clickAway = (e) => {
    ...
    if (
        ...
        e.target.parentElement.classList.contains('shepherd-cancel-icon')
    ) {
        return
    }
        ...
        <div class="">
            ...
            >
                <div
                    ...
                    class="overflow-hidden relative rounded-lg shadow bg-gray-800 flex flex-col justify-start w-full modal-border border-2 border-solid border-transparent"
                    :class="[modalSizeClasses[size], maxHeight]"
                >
                    <div
                        class="p-6 rounded-t flex-none flex justify-between items-top"
                    ...
                    <div
                        ...
                        :class="[
                            !$slots.header ? 'pt-0' : '',
                            scrollContent
                                ? 'overflow-y-auto scrollbar-thin scrollbar-thumb-pink-500 scrollbar-track-none scrollbar-thumb-rounded-full scrollbar-track-rounded-full mr-[3px]'
                                : '',
                            bodyClasses
                        ]"
                    >
                    ...
                    <div
                        v-if="$slots.footer"
                        class="p-6 rounded-b border-t border-solid border-slate-600 flex-none"
                    >
                        <slot name="footer" />
                    </div>
                </div>
