...
<template>
    ...
    >
        <div v-cloak v-show="show" class="absolute top-4 left-0 z-[51] w-full flex justify-center">
            <div
                class="mx-auto py-3 px-3 sm:px-6 lg:px-8 shadow-lg bg-gradient-to-r rounded-lg"
                :class="{
