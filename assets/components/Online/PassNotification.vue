...
<template>
    <div ref="el">
        ...
        <div
            ...
            class="absolute top-4 z-40 shadow-lg w-full flex justify-center"
        >
            <div
                class="mx-auto py-3 px-3 sm:px-6 lg:px-8 bg-gradient-to-r from-pink-500 to-purple-500 rounded-lg"
            >
                <div class="flex flex-wrap items-center justify-center">
                    <div class="flex items-center">
                        ...
                        <p class="ml-3 truncate font-medium text-white">
                            ...
                            <span class="hidden md:inline"
                                >Congratulations! your solution passed.</span
                            >
                        </p>
                    </div>
                    <div
                        v-if="hasOfficialSolution"
                    ...
                    <div
                        v-if="nextExerciseLink"
                        class="order-3 mt-2 w-full flex-shrink-0 sm:order-2 sm:mt-0 sm:w-auto flex"
                    >
                        <span
                            v-if="hasOfficialSolution"
            ...
            <Modal
                size="4xl"
                v-if="openOfficialSolutionModal"
                @close="openOfficialSolutionModal = false"
                body-classes="p-0"
            >
                <template #header>
