...
namespace PhpSchool\Website\PhpWorkshop;
...
class ResultsRenderer
{
    ...
    public function renderResult(ResultInterface $result): string
    {
        return match (get_class($result)) {
            Failure::class, CgiGenericFailure::class, CliGenericFailure::class => $this->renderFailure($result),
    ...
    private function renderFailure(\PhpSchool\PhpWorkshop\Result\FailureInterface $result): string
    {
        return <<<EOT
            <li class="flex items-start space-x-3">
